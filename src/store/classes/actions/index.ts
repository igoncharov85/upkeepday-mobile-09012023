...
import { IClassesEditName, IClassesUpdateSession, IGeneratedClasses, IGeneratedClassesRequest, TClassesId, TClassesStatus } from "../../../common/types/classes.types";
...
export const updatedStatusClassesAction = createAction<'Archived' | 'Scheduled'>(ClassesConstantsEnum.UPDATE_STATUS_CLASEES)
