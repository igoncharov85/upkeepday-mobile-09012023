...
export const DateRecurrenceScreen: React.FC<IDateRecurrenceScreen> = () => {
    ...
    //@ts-ignore
    let { endScheduleType, finishDate, numberOf, buttonTitle } = route?.params || {
    ...
    const goNextStep = async () => {
        ...
        //@ts-ignore
        navigation.navigate(NavigationEnum.DATE_PREVIEW_SCREEN, { buttonTitle: buttonTitle ? t('stepCounter').replace('{step}', '6').replace('{total}', '10') : undefined });
    }
