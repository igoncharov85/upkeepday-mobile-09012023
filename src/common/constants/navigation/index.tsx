...
export enum NavigationEnum {
  ...
  STUDENT_PAYMENTS_SCREEN = 'navigation/STUDENT_PAYMENTS_SCREEN',
  PAYMENTS_TABLE_SCREEN = 'navigation/PAYMENTS_TABLE_SCREEN',
  PAYMENT_STUDENT_TRACKING = 'navigation/PAYMENT_STUDENT_TRACKING',
  //MORE
