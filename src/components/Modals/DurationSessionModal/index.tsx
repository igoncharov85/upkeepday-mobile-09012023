...
import CustomTimePicker from '../SelectDurationSessionModal/CustomTimePicker';
...
const DurationSessionModal = ({
  ...
  const { addDuration } = route.params as any
    ...
    <>
      <View style={styles.modalWrapper}>
        ...
        <View style={styles.container}>
          ...
          <CustomTimePicker block={
            { hour: true, minute: true, dayPart: true }
          } visible={true} onSetTime={onSetTime} data={{ hour: 0, minute: 0 }} />
