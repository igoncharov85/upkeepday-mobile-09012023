...
export const SelectDateScreen: React.FC<ISelectDateScreen> = memo(() => {
  ...
  const [startDate, setStartDate] = useState(
    createCurrentClassRequest.Class?.StartDate
      ? createCurrentClassRequest.Class?.StartDate
      : '',
  );
      ...
      <View
        ...
        <View>
          ...
          <ListButtons
            ...
            label="Class Type"
            onPress={handleTypeLocation}
            index={typeNumberRef.current}
          />
  ...
  const FormikSelectDateScreen = withFormik<any, typeof formInitialValues>({
    ...
    handleSubmit: values => {
      ...
      navigate(NavigationEnum.DATE_RECURRENCE_SCREEN, {
        endScheduleType: typeRef.current,
