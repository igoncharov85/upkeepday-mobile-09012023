...
const SessionButton: FC<AddSessionProps> = ({
  title,
  onPress,
  disabled,
  rainbow,
  ...
  return (
    <LinearGradient
      colors={rainbow ? ['#EAAFC8', '#654EA3'] : ['#FFF', '#FFF']}
      start={{x: 0.0, y: 1.0}}
      end={{x: 0.0, y: 0.0}}
      style={{
        marginVertical: 0,
      ...
      <TouchableOpacity
        ...
        <View
          style={[
            ...
            styles.sessionBlock,
            disabled ? styles.sessionBlockDisabled : null,
          ]}>
          <Text
            style={[
              styles.sessionText,
              ,
              disabled ? styles.sessionTextDisabled : null,
            ]}>
            {title}
          </Text>
        </View>
