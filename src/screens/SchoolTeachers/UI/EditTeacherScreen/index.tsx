...
import { useEditTeacher } from "../../presenters/useEditTeacher";
...
export const EditTeacherScreen: FC = () => {
	...
	return (
		<KeyboardAvoidingView behavior={Utils.isIOS ? 'padding' : undefined} style={styles.container}>
			<ScreenContainer scrollEnabled headerComponent={<ScreenHeader containerStyle={styles.header} text={t('editTeacher')} withBackButton={true} onBackPress={goBack} />}>
				...
				<CustomButton style={styles.button} disabled={!isValid} loading={isLoading} text={'Save Teacher'} onPress={onEdit} />
			</ScreenContainer>
