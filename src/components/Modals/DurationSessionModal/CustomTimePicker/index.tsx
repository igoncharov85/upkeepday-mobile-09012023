...
const CustomTimePicker: React.FC<ITimePicker> = ({ visible, data, onSetTime, block, maxDuration }) => {
...
const ItemPicker = memo(({ items, activeIndex, onChange, block, stipulation }: { items: any[], activeIndex?: number; onChange: (value: any) => void, block?: boolean, stipulation: any }) => {
