...
export const ClassesEditDateScreen: React.FC<ISelectDateScreen> = memo(() => {
                ...
                <View>
                    ...
                    {endScheduleType == EndScheduleType.FixedMonthNumber ||
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            />
                            <ListGradientCircleButtons onPress={() => { }} buttons={['Weeks', 'Months']} />
                        </View>}
    ...
    const FormikSelectDateScreen = withFormik<any, typeof formInitialValues>({
        ...
        handleSubmit: (values,) => {
            ...
            dispatch(fetchGeneratedClassesAction({ id: item.ClassId, to: sendString, schoolId: currentSchool?.SchoolId }))
            navigation.navigate(
                //@ts-ignore
