...
export const PaymentTrackingSetUp: React.FC = () => {
  ...
  const {makeupRequired, trackPrepayment} =
    route.params as IPaymentTrackingSetUp;
  console.log(
    'trackPrepayment',
    trackPrepayment,
    'makeupRequired',
  ...
  const location =
    createCurrentClassRequest.Location?.LocationType === 'Online'
      ? {
  ...
  const goTextStep = () => {
    // @ts-ignore
    const endDate = findLatestLessonWithDuration(
      createCurrentClassRequest?.Sessions,
    );
        ...
        dispatch(
          createScheduleAction({
            Class: {
              ...
              StartDate: createCurrentClassRequest.Class?.StartDate,
              EndDate:
                createCurrentClassRequest.Class?.EndScheduleType ==
                'SpecificEndDate'
                  ? createCurrentClassRequest.Class?.EndDate
                  : undefined,
              EndNumber:
                createCurrentClassRequest.Class?.EndScheduleType !=
                'SpecificEndDate'
            ...
            Sessions:
              createCurrentClassRequest.Sessions as IGeneratedScheduleEntries[],
          }),
        );
        //@ts-ignore
              ...
              <View
                ...
                <InputForm
                  ...
                  style={{
                    ...
                    borderRadius: 10,
                    borderWidth: 1,
                    borderColor: 'rgba(154, 128, 186,0.5)',
                    textAlign: 'center',
                  }}
                />
              </View>
