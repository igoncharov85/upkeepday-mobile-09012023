...
export const ExistingStudent: React.FC<IExistingStudentProps> = ({
  ...
  return (
    <View style={{}}>
        ...
        <View style={styles.container}>
          <View>
            {filteredStudents
              ...
              .map(user => {
                //@ts-ignore
                let active = selectedUsers.some(selectedUser =>
                  user?.EnrolledClasses
                    ? selectedUser?.StudentId === user?.StudentId
      ...
      <View
        style={{padding: 20, height: 92, flex: 1, justifyContent: 'flex-end'}}>
